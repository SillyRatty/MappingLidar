...
const uint8_t ADDRESS_DEFAULT = 0x52;
...
VL53L0X::VL53L0X(I2C_HandleTypeDef *hi2c){
    this->i2c = hi2c;
...
void VL53L0X::writeReg(uint8_t reg, uint8_t value){
    uint8_t writeCommand[2] = {reg, value};
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address,
            writeCommand, sizeof(writeCommand) / sizeof(uint8_t), 200);
}

// Write a 16-bit register
void VL53L0X::writeReg16Bit(uint8_t reg, uint16_t value){
    uint8_t writeCommand[3] = {reg, (uint8_t) (value >> 8), (uint8_t) (value
            & 0xFF)};
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address,
            writeCommand, sizeof(writeCommand) / sizeof(uint8_t), 200);
}
...
void VL53L0X::writeReg32Bit(uint8_t reg, uint32_t value){
    uint8_t writeCommand[5] = {reg, (uint8_t) (value >> 24), (uint8_t) (value
            >> 16), (uint8_t) (value >> 8), (uint8_t) (value & 0xFF)};
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address,
            writeCommand, sizeof(writeCommand) / sizeof(uint8_t), 200);
}
...
uint8_t VL53L0X::readReg(uint8_t reg){
    ...
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address, &reg,
            sizeof(reg) / sizeof(uint8_t), 200);
    this->last_status = HAL_I2C_Master_Receive(this->i2c, this->address, &value,
            sizeof(value) / sizeof(uint8_t), 200);
...
uint16_t VL53L0X::readReg16Bit(uint8_t reg){
    ...
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address, &reg,
            sizeof(reg) / sizeof(uint8_t), 200);
    this->last_status = HAL_I2C_Master_Receive(this->i2c, this->address,
            (uint8_t*) &value, sizeof(value) / sizeof(uint8_t), 200);
...
uint32_t VL53L0X::readReg32Bit(uint8_t reg){
    ...
    value = (value << 24 & 0xFF << 24) | (value << 8 & 0xFF << 16)
            | (value >> 8 & 0xFF << 8) | (value >> 24 & 0xFF);
    return value;
}
...
void VL53L0X::writeMulti(uint8_t reg, uint8_t const *src, uint8_t count){
    ...
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address,
            writeData, sizeof(writeData) / sizeof(uint8_t), 200);
}
...
void VL53L0X::readMulti(uint8_t reg, uint8_t *dst, uint8_t count){
    this->last_status = HAL_I2C_Master_Transmit(this->i2c, this->address, &reg,
            sizeof(reg) / sizeof(uint8_t), 200);
    this->last_status = HAL_I2C_Master_Receive(this->i2c, this->address, dst,
            count, 200);
}
