 ...
 */
MPU6050::MPU6050(uint8_t address, void *wireObj) : devAddr(address), wireObj(
        wireObj){
}
 ...
 * the default internal clock source.
 */
void MPU6050::initialize(ACCEL_FS accelRange, GYRO_FS gyroRange){
    setClockSource(MPU6050_CLOCK_PLL_XGYRO);
 ...
 */
float MPU6050::get_acce_resolution(){
...
void MPU6050::setFullScaleGyroRange(uint8_t range){
    ...
    MPU6050_GCONFIG_FS_SEL_BIT, MPU6050_GCONFIG_FS_SEL_LENGTH, range, wireObj);
}
...
void MPU6050::setAccelXSelfTest(bool enabled){
    ...
    MPU6050_ACONFIG_XA_ST_BIT, enabled, wireObj);
}
...
void MPU6050::setAccelYSelfTest(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_ACCEL_CONFIG,
    MPU6050_ACONFIG_YA_ST_BIT, enabled, wireObj);
}
...
void MPU6050::setAccelZSelfTest(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_ACCEL_CONFIG,
    MPU6050_ACONFIG_ZA_ST_BIT, enabled, wireObj);
}
...
uint8_t MPU6050::getFullScaleAccelRange(){
    ...
    MPU6050_ACONFIG_AFS_SEL_BIT, MPU6050_ACONFIG_AFS_SEL_LENGTH, buffer,
            I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
uint8_t MPU6050::getDHPFMode(){
    I2Cdev::readBits(devAddr, MPU6050_RA_ACCEL_CONFIG,
    MPU6050_ACONFIG_ACCEL_HPF_BIT, MPU6050_ACONFIG_ACCEL_HPF_LENGTH, buffer,
            I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlave3FIFOEnabled(bool enabled){
    ...
    MPU6050_SLV_3_FIFO_EN_BIT, enabled, wireObj);
}
...
void MPU6050::setSlaveReadWriteTransitionEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_I2C_MST_CTRL,
    MPU6050_I2C_MST_P_NSR_BIT, enabled, wireObj);
}
...
bool MPU6050::getSlaveEnabled(uint8_t num){
    ...
    MPU6050_I2C_SLV_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlaveEnabled(uint8_t num, bool enabled){
    ...
    MPU6050_I2C_SLV_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getSlaveWordByteSwap(uint8_t num){
    if(num > 3)
        return 0;
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_BYTE_SW_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlaveWordByteSwap(uint8_t num, bool enabled){
    if(num > 3)
        return;
    I2Cdev::writeBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_BYTE_SW_BIT, enabled, wireObj);
}
...
bool MPU6050::getSlaveWriteMode(uint8_t num){
    if(num > 3)
        return 0;
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_REG_DIS_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlaveWriteMode(uint8_t num, bool mode){
    if(num > 3)
        return;
    I2Cdev::writeBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_REG_DIS_BIT, mode, wireObj);
}
...
bool MPU6050::getSlaveWordGroupOffset(uint8_t num){
    if(num > 3)
        return 0;
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_GRP_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlaveWordGroupOffset(uint8_t num, bool enabled){
    if(num > 3)
        return;
    I2Cdev::writeBit(devAddr, MPU6050_RA_I2C_SLV0_CTRL + num * 3,
    MPU6050_I2C_SLV_GRP_BIT, enabled, wireObj);
}
...
void MPU6050::setSlaveDataLength(uint8_t num, uint8_t length){
    ...
    MPU6050_I2C_SLV_LEN_BIT, MPU6050_I2C_SLV_LEN_LENGTH, length, wireObj);
}
...
bool MPU6050::getSlave4InterruptEnabled(){
    ...
    MPU6050_I2C_SLV4_INT_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlave4InterruptEnabled(bool enabled){
    ...
    MPU6050_I2C_SLV4_INT_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getSlave4WriteMode(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_SLV4_CTRL,
    MPU6050_I2C_SLV4_REG_DIS_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setSlave4WriteMode(bool mode){
    I2Cdev::writeBit(devAddr, MPU6050_RA_I2C_SLV4_CTRL,
    MPU6050_I2C_SLV4_REG_DIS_BIT, mode, wireObj);
}
...
bool MPU6050::getPassthroughStatus(){
    ...
    MPU6050_MST_PASS_THROUGH_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave4IsDone(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV4_DONE_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getLostArbitration(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_LOST_ARB_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave4Nack(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV4_NACK_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave3Nack(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV3_NACK_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave2Nack(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV2_NACK_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave1Nack(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV1_NACK_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getSlave0Nack(){
    I2Cdev::readBit(devAddr, MPU6050_RA_I2C_MST_STATUS,
    MPU6050_MST_I2C_SLV0_NACK_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getInterruptMode(){
    ...
    MPU6050_INTCFG_INT_LEVEL_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setInterruptMode(bool mode){
    ...
    MPU6050_INTCFG_INT_LEVEL_BIT, mode, wireObj);
}
...
bool MPU6050::getInterruptDrive(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_INT_OPEN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setInterruptDrive(bool drive){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_INT_OPEN_BIT, drive, wireObj);
}
...
bool MPU6050::getInterruptLatch(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_LATCH_INT_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setInterruptLatch(bool latch){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_LATCH_INT_EN_BIT, latch, wireObj);
}
...
bool MPU6050::getInterruptLatchClear(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_INT_RD_CLEAR_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setInterruptLatchClear(bool clear){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_INT_RD_CLEAR_BIT, clear, wireObj);
}
...
bool MPU6050::getFSyncInterruptLevel(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_FSYNC_INT_LEVEL_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setFSyncInterruptLevel(bool level){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_FSYNC_INT_LEVEL_BIT, level, wireObj);
}
...
bool MPU6050::getFSyncInterruptEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_FSYNC_INT_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setFSyncInterruptEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_FSYNC_INT_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getI2CBypassEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_I2C_BYPASS_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setI2CBypassEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_I2C_BYPASS_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getClockOutputEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_CLKOUT_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setClockOutputEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_PIN_CFG,
    MPU6050_INTCFG_CLKOUT_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getIntFIFOBufferOverflowEnabled(){
    ...
    MPU6050_INTERRUPT_FIFO_OFLOW_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setIntFIFOBufferOverflowEnabled(bool enabled){
    ...
    MPU6050_INTERRUPT_FIFO_OFLOW_BIT, enabled, wireObj);
}
...
bool MPU6050::getIntI2CMasterEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_I2C_MST_INT_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setIntI2CMasterEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_I2C_MST_INT_BIT, enabled, wireObj);
}
...
bool MPU6050::getIntDataReadyEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_DATA_RDY_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setIntDataReadyEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_DATA_RDY_BIT, enabled, wireObj);
}
...
bool MPU6050::getXNegMotionDetected(){
    ...
    MPU6050_MOTION_MOT_XNEG_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getXPosMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_XPOS_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getYNegMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_YNEG_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getYPosMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_YPOS_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getZNegMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_ZNEG_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getZPosMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_ZPOS_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
/** Get zero motion detection interrupt status.
 * @return Motion detection status
...
bool MPU6050::getZeroMotionDetected(){
    I2Cdev::readBit(devAddr, MPU6050_RA_MOT_DETECT_STATUS,
    MPU6050_MOTION_MOT_ZRMOT_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
bool MPU6050::getExternalShadowDelayEnabled(){
    ...
    MPU6050_DELAYCTRL_DELAY_ES_SHADOW_BIT, buffer, I2Cdev::readTimeout,
            wireObj);
    return buffer[0];
}
...
void MPU6050::setExternalShadowDelayEnabled(bool enabled){
    ...
    MPU6050_DELAYCTRL_DELAY_ES_SHADOW_BIT, enabled, wireObj);
}
...
void MPU6050::resetGyroscopePath(){
    ...
    MPU6050_PATHRESET_GYRO_RESET_BIT, true, wireObj);
}
...
void MPU6050::resetAccelerometerPath(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_SIGNAL_PATH_RESET,
    MPU6050_PATHRESET_ACCEL_RESET_BIT, true, wireObj);
}
...
void MPU6050::resetTemperaturePath(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_SIGNAL_PATH_RESET,
    MPU6050_PATHRESET_TEMP_RESET_BIT, true, wireObj);
}
...
void MPU6050::setFIFOEnabled(bool enabled){
    ...
    MPU6050_USERCTRL_FIFO_EN_BIT, enabled, wireObj);
}
...
bool MPU6050::getI2CMasterModeEnabled(){
    ...
    MPU6050_USERCTRL_I2C_MST_EN_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
...
void MPU6050::setI2CMasterModeEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_I2C_MST_EN_BIT, enabled, wireObj);
}
...
void MPU6050::switchSPIEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_I2C_IF_DIS_BIT, enabled, wireObj);
}
/** Reset the FIFO.
...
void MPU6050::resetFIFO(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_FIFO_RESET_BIT, true, wireObj);
}
...
void MPU6050::resetI2CMaster(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_I2C_MST_RESET_BIT, true, wireObj);
}
...
void MPU6050::resetSensors(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_SIG_COND_RESET_BIT, true, wireObj);
}
...
void MPU6050::reset(){
    ...
    MPU6050_PWR1_DEVICE_RESET_BIT, true, wireObj);
}
...
int8_t MPU6050::GetCurrentFIFOPacket(uint8_t *data, uint8_t length){ // overflow proof
    ...
    do{
        if((fifoC = getFIFOCount()) > length){
            ...
            if(fifoC > 200){ // if you waited to get the FIFO buffer to > 200 bytes it will take longer to get the last packet in the FIFO Buffer than it will take to  reset the buffer and wait for the next to arrive
                ...
                while(!(fifoC = getFIFOCount())
                        && ((millis() - BreakTimer) <= (getFIFOTimeout()))); // Get Next New Packet
            }
                    ...
                    while(fifoC){ // fifo count will reach zero so this is safe
                        RemoveBytes =
                                (fifoC < I2CDEVLIB_WIRE_BUFFER_LENGTH) ?
                                        fifoC : I2CDEVLIB_WIRE_BUFFER_LENGTH; // Buffer Length is different than the packet length this will efficiently clear the buffer
        ...
        if(!packetReceived && (millis() - BreakTimer) > (getFIFOTimeout()))
            return 0;
...
uint8_t MPU6050::getDeviceID(){
    ...
    MPU6050_WHO_AM_I_LENGTH, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
/** Set Device ID.
...
void MPU6050::setDeviceID(uint8_t id){
    ...
    MPU6050_WHO_AM_I_LENGTH, id, wireObj);
}
...
bool MPU6050::getIntPLLReadyEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_PLL_RDY_INT_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
void MPU6050::setIntPLLReadyEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_PLL_RDY_INT_BIT, enabled, wireObj);
}
bool MPU6050::getIntDMPEnabled(){
    I2Cdev::readBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_DMP_INT_BIT, buffer, I2Cdev::readTimeout, wireObj);
    return buffer[0];
}
void MPU6050::setIntDMPEnabled(bool enabled){
    I2Cdev::writeBit(devAddr, MPU6050_RA_INT_ENABLE,
    MPU6050_INTERRUPT_DMP_INT_BIT, enabled, wireObj);
}
...
void MPU6050::resetDMP(){
    I2Cdev::writeBit(devAddr, MPU6050_RA_USER_CTRL,
    MPU6050_USERCTRL_DMP_RESET_BIT, true, wireObj);
}
...
bool MPU6050::writeMemoryBlock(const uint8_t *data, uint16_t dataSize,
    ...
    setMemoryStartAddress(address);
    uint8_t chunkSize;
    uint8_t verifyBuffer[MPU6050_DMP_MEMORY_CHUNK_SIZE] = {0};
    ...
    for(i = 0; i < dataSize;){
        ...
        if(verify){
            ...
            I2Cdev::readBytes(devAddr, MPU6050_RA_MEM_R_W, chunkSize,
                    verifyBuffer, I2Cdev::readTimeout, wireObj);
        }
...
void MPU6050::PID(uint8_t ReadAddress, float kP, float kI, uint8_t Loops){
    ...
    for(int i = 0; i < 3; i++){
        I2Cdev::readWords(devAddr, SaveAddress + (i * shift), 1,
                (uint16_t*) &Data, I2Cdev::readTimeout, wireObj); // reads 1 or more 16 bit integers (Word)
        Reading = Data;
        if(SaveAddress != 0x13){
    ...
    for(int L = 0; L < Loops; L++){
        ...
        for(int c = 0; c < 100; c++){                     // 100 PI Calculations
            ...
            for(int i = 0; i < 3; i++){
                ...
                I2Cdev::writeWords(devAddr, SaveAddress + (i * shift), 1,
                        (uint16_t*) &Data, wireObj);
            }
...
int16_t* MPU6050::GetActiveOffsets(){
    ...
    if(AOffsetRegister == 0x06)
        ...
        I2Cdev::readWords(devAddr, AOffsetRegister + 3, 1,
                (uint16_t*) (offsets + 1), I2Cdev::readTimeout, wireObj);
        I2Cdev::readWords(devAddr, AOffsetRegister + 6, 1,
                (uint16_t*) (offsets + 2), I2Cdev::readTimeout, wireObj);
    }
